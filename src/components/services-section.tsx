...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center mb-12">
          {/* <h2 className="text-3xl md:text-4xl font-bold flex items-center">
            <span className="text-yellow-300 mr-2">✨</span> Our Services
          </h2> */}
...
<div
        ...
        >
          ...
          <Button variant="outline" className="text-gray-800 border-white hover:bg-white/10">
